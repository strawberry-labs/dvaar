...
const Card2 = () => {
  const logs = [
    ...
    },
    {
      ...
      type: "POST",
      timestamp: "14:23:47",
      message: "/api/auth/login - 200 OK (45ms)",
      icon: (
        <div className="h-8 w-8 rounded-full bg-muted flex items-center justify-center">
          <ServerIcon className="h-5 w-5 text-foreground" />
        </div>
      ),
    },
    {
      ...
      type: "GET",
      timestamp: "14:23:50",
      message: "/api/products - 200 OK (23ms)",
      icon: (
        <div className="h-8 w-8 rounded-full bg-muted flex items-center justify-center">
          <GlobeIcon className="h-5 w-5 text-foreground" />
        </div>
    ...
    },
    {
      ...
      type: "POST",
      timestamp: "14:23:55",
      message: "/api/orders - 201 Created (89ms)",
      icon: (
        <div className="h-8 w-8 rounded-full bg-muted flex items-center justify-center">
          <ServerIcon className="h-5 w-5 text-foreground" />
        </div>
        ...
        <div className="border-b items-center justify-center overflow-hidden rounded-t-xl h-4/5 w-full flex">
          <div className="relative flex items-center justify-center h-full w-full">
            ...
            <OrbitingCircles duration={15} delay={20} radius={80}>
              <div className="h-8 w-8 rounded-full bg-muted border flex items-center justify-center">
                <MonitorIcon className="h-5 w-5 text-foreground" />
              </div>
            </OrbitingCircles>
            <OrbitingCircles radius={120} duration={20} delay={20}>
              <div className="h-8 w-8 rounded-full bg-muted border flex items-center justify-center">
                <SmartphoneIcon className="h-5 w-5 text-foreground" />
              </div>
            </OrbitingCircles>
